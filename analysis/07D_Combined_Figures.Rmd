...
```{r fig-2G}
genes.list <- list(
    `4` = c("GNG11", "CLDN5", "ESAM", "CD34", "PECAM1", "PLXND1", "APLN", 
            "CXCR4", "HEY1", "ICAM1", "CXCL2", "CXCL1", "CXCL8"),
    `0` = c("TAGLN", "ALDH1A2", "COL6A3", "ALX1", "PDGFRA", "ACTA2", "NRK", 
            "STMN2", "SULT1E1", "GPC3", "SERPINH1", "EGR1", "CCBE1"),
    `1` = c("DCN", "COL1A1", "LUM", "IGF1", "POSTN", "SFRP2", "ACTA2", "DKK1", 
            "PALLD", "WNT2B", "DKK2", "SEMA3C", "CRABP1"),
    `2` = c("MGP", "GATA3", "PDGFRB", "MEF2C", "SSBP4", "FTL", "REN", "ID1", 
            "ITGA8", "ANGPT2", "DLK1", "APOE", "SLN"),
    `3` = c("ZFHX4", "CTSK", "HNRNPA1", "MAB21L2", "PRRX1", "MDK", "SRGAP1",
            "VIM", "SOX6", "ACTA2", "NR2F1", "ANGPT1", "TSPYL2"),
    `9` = c("COL9A3", "DCN", "LUM", "FIBIN", "OGN", "SOX9", "CNMD", "MIA",
            "GNG5", "PLPP3", "SPON2", "ITM2B", "MATN4"),
    `13` = c("HBG1", "HBB", "HBA2", "HBA1", "HBM", "AHSP", "ALAS2", "GYPC", 
             "SLC25A3", "GPX1", "FSCN1", "FKBP1A", "EIF4G2"),
    `11` = c("TTYH1", "S100B", "FABP7", "SOX2", "AP1S2", "MSX1", "TUBB2B",
             "RELN", "GFRA3", "SEMA3G", "NTRK2", "LYPD1", "PTN"),
    `14` = c("HES6", "TUBB2B", "CRABP1", "STMN2", "TUBA1A", "DCX", "ELAVL3",
             "SOX11", "ELAVL4", "ATOH1", "RBP1", "NCAM1", "STMN1"),
    `12` = c("PTPRC", "CD74", "SRGN", "S100A9", "TYROBP", "HLA-DPB1", "S100A8",
             "LYZ", "FCER1G", "CXCL8", "HLA-DRB1", "HLA-DRA", "IL1B")
)
...
plot.data <- plot.data %>%
    ...
    mutate(Cluster = factor(Cluster,
                            ...
                            labels = clust.labs)) %>%
    mutate(Gene = factor(Gene, levels = unique(unlist(genes.list))))
...
genes.list <- list(
    ...
    c("CCND1", "CXCL1", "HNRNPR", "STMN1", "VEGFA", "SYNPO", "WT1", "PTPRO"),
    c("PTGR1", "TSC22D1", "DDX5", "MALAT1", "CITED2", "FTL", "BNIP3", "LHX1"),
    c("SEPHS2", "BEX1", "COX14", "ELF3", "HNF1B", "LHX1", "VAMP8", "CITED2"),
    c("SFRP1", "CTDNEP1", "HNRNPAB", "PCSK1N", "PITX2", "H1FX", "MID1", 
      "LINC00632"),

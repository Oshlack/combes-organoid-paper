...
```{r pkg-bib}
write_bib(c("base", "SingleCellExperiment", "cowplot"),
...
(v`r packageVersion("cowplot")`) [@R-cowplot] packages.
...
http://oshlack.github.io/combes-organoid-paper and the analysis code is

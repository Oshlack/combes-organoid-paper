...
de.c7c15 %>% rownames_to_column("gene") %>% top_n(10, avg_logFC) %>% data.frame
```
...
de.c7c15.lind %>% rownames_to_column("gene") %>%
...
write_csv(de.c7c15.lind, here("output", DOCNAME, "c7_c17_lind_de.csv"))

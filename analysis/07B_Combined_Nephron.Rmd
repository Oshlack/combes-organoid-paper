...
write_csv(pod.de, here("output", DOCNAME, "podocyte_de.csv"))
write_csv(pod.de.filt, here("output", DOCNAME, "podocyte_de_filtered.csv"))
...
kable(data.frame(
    File = c(
        ...
        glue("[podocyte_de.csv]",
             "({getDownloadURL('podocyte_de.csv', DOCNAME)})"),
        glue("[podocyte_de_filtered.csv]",
             "({getDownloadURL('podocyte_de_filtered.csv', DOCNAME)})")
    ),
    Description = c(
